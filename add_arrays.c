...
int main(int argc, char *argv[])
{
    ...
    for (int s = 0; s < numSizes; s++)
    {
        ...
        // Exécuter l'addition plusieurs fois et mesurer les temps
        for (int i = 0; i < numExecutions; i++)
        {
            ...
            {
                resultArray[j] = array1[j] + array2[j]; // Addition élément par élément
            }

            clock_t end = clock();
            executionTimes[i] = (double)(end - start) / CLOCKS_PER_SEC; // Convertir en secondes
        }
